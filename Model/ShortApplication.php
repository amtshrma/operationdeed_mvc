<?php    
class ShortApplication extends AppModel {
    var $name = 'ShortApplication';
	public $virtualFields = array(
		'name' => 'CONCAT(ShortApplication.applicant_first_name, " ", ShortApplication.applicant_last_name)'
	);
	public $hasOne = array('PropertyDetail','SoftQuote');
	public $hasMany = array(
        'PropertyHistory' => array(
            'className' => 'PropertyHistory',
        ),
		'PropertyComparable' => array(
            'className' => 'PropertyComparable',
        )
    );
    ...
    public $validate = array(
        ...
        'property_zipcode' => array(
            'rule'    => 'notEmpty',
            'message' => 'Enter property zipcode'
        ),
        'loan_type' => array(
            'rule'    => 'notEmpty',
	...
	/**
	 * Description :- applicantCompanyName
	 * @var object :- NULL
	*/
	
	function applicantCompanyName(){
		if($this->data['ShortApplication']['company_select'] == 'Individual'){
            return true;
        }else{
            if($this->data['ShortApplication']['applicant_company_name']) {
				return true;
			}else {
				return false;
			}
