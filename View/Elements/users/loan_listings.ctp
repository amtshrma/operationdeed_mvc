    ...
    <table class="table table-striped table-flip-scroll cf table-hover table-condensed">
      ...
      <?php
			...
			foreach($loans as $key => $loan) {
              ...
              //$statusImg = ($loan['Loan']['status'] == 1) ? '<i class="fa fa-thumbs-up green"></i>' : '<i class="fa fa-thumbs-down red"></i>';
              //echo $this->Form->hidden('status',array('value'=>$status,'id'=>'statusHidden_'.$loanid));
              ?>				
              <tr>
                  ...
                  <td class="v-align-middle">
                      ...
                      if(array_key_exists($status, $loanStatus)) {
                          ...
                          echo '<label class="'.$statusClass[$status].'" >'.$loanStatus[$status].'</label>';
                  ...
                  <td align="right"><?php echo _numberFormatCS($loan['Loan']['loan_amount']); ?></td>
                  <td><?php echo $loan['Loan']['proprty_type']; ?></td>
                  <td><?php echo $loan['Loan']['state']; ?></td>
                  <td><?php echo $loan['Loan']['city']; ?></td>
                  <td class="v-align-middle">
                      <div class="fa-hover">
                          <?php
