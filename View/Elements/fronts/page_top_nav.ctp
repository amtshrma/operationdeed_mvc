 <div class="container">
    <div class="compressed">
      <div class="navbar-header">
        ...
        <?php echo $this->html->link($this->html->image('logo.png',array('data-src' => Configure::read('BASE_URL').'img/logo.png','data-src-retina' => Configure::read('BASE_URL').'img/logo.png','width' => '119','height' => '80')),'/',array('escape'=>false,'class'=>'navbar-brand compressed'));?>
      </div>
