			...
			<div class="table-responsive">
				<table class="table table-bordered table-hover"> 
					<tbody>
						...
						<tr>
							<td>User Name:</td><td><?php echo $userPaymentDetail['User']['first_name'].' '.$userPaymentDetail['User']['last_name'];?></td>
						</tr>
						<tr>
							<td>Email Address :</td><td><?php echo $userPaymentDetail['User']['email_address'];?></td>
						</tr>
						<tr>
							<td>Commission (%) :</td><td><?php echo $userPaymentDetail['UserPayment']['commission_percentage'].' %';?></td>
						</tr>
						<tr>
							<td>Comment :</td>
							<td><?php
