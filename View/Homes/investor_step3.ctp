                ...
                <div class="panel-body">
                    ...
                    <center>
                        <div class="form-group">
                            ...
                            <?php
                            if($this->Session->read('userSessionData.user_type') == '7'){ ?>
                            <div class="row">
                                <div class="col-lg-6">
                                    <?php
                                    $investorList = $this->Common->getInvestorManagerList();
                                    echo $this->Form->input('UserDetail.referred_by_user_id',array('label' => false,'div' => false, 'empty' => 'Select Investment Manager','options'=>$investorList,'class' => 'form-control','maxlength' => 55));?>
                                </div>
                                <div class="col-lg-6">
