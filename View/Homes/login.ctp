...
<?php echo $this->Form->create('User', array('class'=>'form-signin','novalidate'=>'novalidate','id' => 'loginForm')); ?>
	<div class="whitebox">
		...
		<br />
		<?php
			echo $this->Html->link('&nbsp;&nbsp;&nbsp;&nbsp;Sign in with LinkedIn','javascript:void(0);',array('data-target' => '#userTypePopUp','data-toggle' => 'modal','escape' =>false,'class' => 'socialButton btn btn-lg btn-linkedin btn-block','id' =>'LinkedIn'));
			...
			echo $this->Html->link('&nbsp;Sign in with Twitter','javascript:void(0);',array('data-target' => '#userTypePopUp','data-toggle' => 'modal','escape' =>false,'class' => 'socialButton btn btn-lg btn-twitter btn-block','id' =>'Twitter'));
		?>
	...
	<div style="text-align:center"><?php echo $this->Html->link('<b>Forgot Password</b>',array('controller'=>'homes','action'=>'forgot_password'),array('escape'=>false));?></div>
