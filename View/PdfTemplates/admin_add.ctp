...
<div class="page-content">
 <div class="content">
      <ul class="breadcrumb">
        ...
        <li>
        <?php echo $this->Html->link('Email Templates', array('controller'=>'pdf_templates','action'=>'index'),array('class'=>'active'));?>
        </li>
      </ul>
   ...
   <div class="row">
      <div class="col-md-12">
        <div class="grid simple">
          ...
          <?php
            echo $this->Form->create(null, array('url' => array('controller' => 'pdf_templates', 'action' => 'add'),'id'=>'emailTemplateId'));              
