...
<body>
    ...
    <?php
        echo $this->Html->script(array('front/jquery-ui.js','front/short_app.js','front/bower_components/bootstrap/dist/js/bootstrap.min.js','front/bower_components/metisMenu/dist/metisMenu.min.js','front/dist/js/sb-admin-2.js','bootstrap-datepicker/bootstrap-datepicker','jquery.maskedinput','escrow.js'));
    ?>
    <script>
