...
<body>
    <div id="wrapper">
        <!-- Navigation -->
        <?php echo $this->Element('fronts/short_app_nav');?>
        <?php echo $this->fetch('content');?>
    </div>
    <?php
        echo $this->Html->script(array('jquery.validate.js','front/jquery-ui.js','front/short_app.js','front/bower_components/bootstrap/dist/js/bootstrap.min.js','front/bower_components/metisMenu/dist/metisMenu.min.js','front/dist/js/sb-admin-2.js','bootstrap-datepicker/bootstrap-datepicker','jquery.maskedinput'));
    ?>
    <script>
