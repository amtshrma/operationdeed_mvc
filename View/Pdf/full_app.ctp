...
$amount = (!empty($loanDetail['ShortApplication']['loan_amount'])) ? $loanDetail['ShortApplication']['loan_amount'] : '';
$interestRate = '0.30';
                    ...
                    <td>
                         <table>
                            ...
                            <tr>
                                ...
                                if(isset($data['LongAppBorrower']['borrower_dependent_age'])){
