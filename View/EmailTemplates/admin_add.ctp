...
<div class="page-content">
 <div class="content">
      <ul class="breadcrumb">
        ...
        <li>
        <?php echo $this->Html->link('Email Templates', array('controller'=>'email_templates','action'=>'index'),array('class'=>'active'));?>
        </li>
      </ul>
      <div class="page-title"> <i class="icon-custom-left"></i>
        <h3><?php echo $action; ?> - <span class="semi-bold">Email Template</span></h3>
      </div> 
   <div class="row">
      <div class="col-md-12">
        <div class="grid simple">
          ...
          <?php
            echo $this->Form->create(null, array('url' => array('controller' => 'email_templates', 'action' => 'add'),'id'=>'emailTemplateId'));              
