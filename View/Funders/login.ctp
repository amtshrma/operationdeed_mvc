<h1 style="text-align: center;">Welcome to Rockland Funder Panel </h1>
<div class="container">
    <div class="row">
        <div class="col-md-6 col-md-offset-3">
            <div class="panel panel-login">
                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-lg-12">
                            <?php echo $this->Form->create('User', array('url' => array('controller' => 'funders', 'action' => 'login'),'id'=>'loginForm','type' => 'file','style'=>'display:block;')); 
                            echo $this->Form->hidden('User.user_type',array('value'=>6,'id'=>'userType')); ?>
