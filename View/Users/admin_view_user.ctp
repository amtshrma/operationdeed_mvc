              ...
              <div class="col-md-12">
                <h4>Additional Information</h4>            
                   <div class="form-group">
                     ...
                     if($licenceType == 'bre') { ?>
                     <div class="col-md-6" id ="BRELiceneRow">
                        <label class="form-label"><strong>BRE License : </strong><?php echo $arrUser['UserDetail']['bre_license_number']; ?></label>
                     </div>
                     <?php } else { ?>
                     <div class="col-md-6" id = "CFLLiceneRow">
                        <label class="form-label"><strong>CFL License : </strong><?php echo $arrUser['UserDetail']['cfl_license_number']; ?></label>
                     </div>
                     <?php } ?>
                  </div>
                  <?php if(!empty($arrUser['UserDetail']['referred_by_user_id'])){ ?>
                  <div class="row form-row">
                     <div class="col-md-6">
                        <label class="form-label">Referred User Name</label>                      
                        <div class="input-with-icon  right">                                       
                         <div class="col-md-12 input-div-border">
                           <div class="input-div-margin"><?php $referred_by_user_id = isset($arrUser['UserDetail']['referred_by_user_id'])?$arrUser['UserDetail']['referred_by_user_id']:'&nbsp;';
