...
class HybridauthComponent extends Component {
        ...
        try {
            ...
            switch ($e->getCode()) {
                ...
                case 1 : $this->error = "Hybriauth configuration error.";
                    break;
                case 2 : $this->error = "PrgetAdapterovider [".$provider."] not properly configured.";
                    break;
	...
	protected function normalizeSocialProfile($provider){
		...
		$socialProfile['User']['email_address'] = $incomingProfile['email'];
		...
		$socialProfile['UserDetail']['profile_picture'] = $incomingProfile['photoURL'];
		...
		if($provider == 'Twitter'){
			...
			$socialProfile['User']['email_address'] = $socialProfile['User']['display_name'] .'@Twitter.com';
		}
